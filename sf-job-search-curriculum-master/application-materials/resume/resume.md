...
[resume]: resume---score-card
[github-resume]: https://github.com/appacademy/sf-job-search-curriculum/blob/master/application-materials/resume/ScoreCard.md
...
a fancier layout if you like, but you must still submit a plain-text Google Doc to us through InterviewDB
...
## Create your resume with one of our formatted templates. 
...
* Avoid extreme language or framework-specific bullets, they are incomprehensible unless the reader knows Rails.
   - Example: "Overwrites attr_writer on User#password"
   
* Remember, that many resumes will go through an ATS so you will want to make sure your content has searchable keywords that might be on a job description
...
Don't organize your skills by proficiency. Ie. Don't do this:
